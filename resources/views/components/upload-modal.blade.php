<div class="modal-overlay" id="modal-overlay">
    <div class="modal-box">
        ...
        <div class="modal-actions">
          ...
          <div class="modal-overlay" id="passport-preview">
    <div class="modal-box">

        <div class="modal-title-row">
            <span class="modal-title-text">Passport Details</span>
            <button class="modal-close" onclick="closePreview()">✕</button>
        </div>

        <div id="passport-data-box" style="font-size:13px; line-height:1.8;">
        </div>
